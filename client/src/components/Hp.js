...
class Hp extends React.Component {
    ...
    render() {
                    ...
                    <div className="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-xl u-sheet-1">
                        ...
                        <nav className="u-menu u-menu-dropdown u-offcanvas u-menu-1">
                            <div className="menu-collapse" style={{ fontSize: '1rem', letterSpacing: '0px' }}>
                                <a className="u-border-3 u-border-grey-75 u-button-style u-custom-left-right-menu-spacing u-custom-padding-bottom u-custom-top-bottom-menu-spacing u-nav-link u-text-active-palette-1-base u-text-hover-palette-2-base u-text-white u-white" href="# " style={{ padding: '4px 6px', fontSize: 'calc(1em + 8px)' }}>
                                    <svg>
                                        <use xmlnsXlink="http://www.w3.org/1999/xlink" xlinkHref="#menu-hamburger" />
                                    </svg>
                            ...
                            <div className="u-custom-menu u-nav-container">
                                <ul className="u-nav u-unstyled u-nav-1">
                                    <li className="u-nav-item"><a className="u-button-style u-nav-link u-text-active-palette-1-base u-text-hover-palette-2-base" href="Home.html" style={{ padding: '10px 20px' }}>Home</a>
                                    </li>
                                    <li className="u-nav-item"><a className="u-button-style u-nav-link u-text-active-palette-1-base u-text-hover-palette-2-base" href="Home.html#sec-d6ef" data-page-id={16819084} style={{ padding: '10px 20px' }}>Contact Us</a>
                                    </li>
                                    <li className="u-nav-item"><a className="u-button-style u-nav-link u-text-active-palette-1-base u-text-hover-palette-2-base" href="Login.html" style={{ padding: '10px 20px' }}>Login</a>
                                    </li>
                                    <li className="u-nav-item"><a className="u-button-style u-nav-link u-text-active-palette-1-base u-text-hover-palette-2-base" href="Signup.html" style={{ padding: '10px 23px 10px 20px' }}>Signup</a>
                                    </li>
                                </ul>
                            </div>
                                ...
                                <div className="u-black u-container-style u-inner-container-layout u-opacity u-opacity-95 u-sidenav">
                                    <div className="u-inner-container-layout u-sidenav-overflow">
                                        ...
                                        <ul className="u-align-center u-nav u-popupmenu-items u-unstyled u-nav-2">
                                            <li className="u-nav-item"><a className="u-button-style u-nav-link" href="Home.html" style={{ padding: '10px 20px' }}>Home</a>
                                            </li>
                                            <li className="u-nav-item"><a className="u-button-style u-nav-link" href="Home.html#sec-d6ef" data-page-id={16819084} style={{ padding: '10px 20px' }}>Contact Us</a>
                                            </li>
                                            <li className="u-nav-item"><a className="u-button-style u-nav-link" href="Login.html" style={{ padding: '10px 20px' }}>Login</a>
                                            </li>
                                            <li className="u-nav-item"><a className="u-button-style u-nav-link" href="Signup.html" style={{ padding: '10px 20px' }}>Signup</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <h4 className="u-align-center-md u-align-center-sm u-align-center-xs u-text u-text-default u-text-1">Big Bookshelf<br />
                        </h4>
                    </div>
                </header>
                <section className="u-clearfix u-white u-section-1" id="carousel_2844">
                                ...
                                <div className="u-layout-row">
                                    <div className="u-container-style u-layout-cell u-left-cell u-size-30 u-layout-cell-1">
                                        <div className="u-container-layout u-valign-middle u-container-layout-1">
                                            ...
                                            <p className="u-text u-text-3">Etiam velit purus, vehicula quis imperdiet dignissim, convallis vitae nisl.
                                            ...
                                            <a href="https://nicepage.com" className="u-active-palette-3-dark-3 u-border-none u-btn u-btn-rectangle u-button-style u-custom-font u-font-pt-sans u-hover-palette-4-dark-3 u-palette-4-dark-2 u-radius-0 u-btn-1">read
                                                more</a>
                                        </div>
                                    </div>
                                    <div className="u-container-style u-layout-cell u-right-cell u-size-30 u-layout-cell-2">
                                        <div className="u-container-layout u-container-layout-2">
                                            <div alt="" className="u-align-left u-image u-image-circle u-image-1" data-image-width={1100} data-image-height={1100} />
                                            <div className="u-shape u-shape-svg u-text-white u-shape-1">
                                                <svg className="u-svg-link" preserveAspectRatio="none" viewBox="0 0 160 50" style={{}}>
                                                    <use xmlnsXlink="http://www.w3.org/1999/xlink" xlinkHref="#svg-7f47" />
                                                </svg>
                                                <svg className="u-svg-content" viewBox="0 0 160 50" x="0px" y="0px" id="svg-7f47" style={{ enableBackground: 'new 0 0 160 50' }}>
      ...
      C11.2,30.2,20.6,29.9,32.2,38z" />
                            ...
                            <div className="u-repeater u-repeater-1">
                                ...
                                <div className="u-align-center u-container-style u-list-item u-repeater-item">
                                    <div className="u-container-layout u-similar-container u-valign-top u-container-layout-2"><span className="u-icon u-icon-circle u-icon-2"><svg className="u-svg-link" preserveAspectRatio="xMidYMin slice" viewBox="0 0 494.758 494.758" style={{}}>
                                        ...
                                        <h3 className="u-text u-text-default u-text-4">Best Pricing</h3>
                                        <p className="u-text u-text-default u-text-5">With so many sellers, we have the best deals coming up in the
                                            market<br />
                                        </p>
                                    </div>
                                </div>
                                <div className="u-align-center u-container-style u-list-item u-repeater-item">
                                    <div className="u-container-layout u-similar-container u-valign-top u-container-layout-3"><span className="u-icon u-icon-circle u-icon-3"><svg className="u-svg-link" preserveAspectRatio="xMidYMin slice" viewBox="0 0 512 512" style={{}}>
                                        <use xmlnsXlink="http://www.w3.org/1999/xlink" xlinkHref="#svg-7610" />
                                    </svg><svg className="u-svg-content" viewBox="0 0 512 512" x="0px" y="0px" id="svg-7610" style={{ enableBackground: 'new 0 0 512 512' }}>
                                            <g>
                                                <g>
                                        ...
                                        <h3 className="u-text u-text-default u-text-6"> Elite Clientele</h3>
                                        <p className="u-text u-text-default u-text-7">We have books, the best books and clients</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <footer className="u-clearfix u-footer u-grey-80" id="sec-4570">
                    <div className="u-clearfix u-sheet u-sheet-1">
                        <div className="u-align-left u-social-icons u-spacing-10 u-social-icons-1">
                            <a className="u-social-url" title="facebook" target="_blank" href><span className="u-icon u-social-facebook u-social-icon u-icon-1"><svg className="u-svg-link" preserveAspectRatio="xMidYMin slice" viewBox="0 0 112 112" style={{}}>
                                <use xmlnsXlink="http://www.w3.org/1999/xlink" xlinkHref="#svg-4b23" />
                            </svg><svg className="u-svg-content" viewBox="0 0 112 112" x={0} y={0} id="svg-4b23">
                                    <circle fill="currentColor" cx="56.1" cy="56.1" r={55} />
                                    <path fill="#FFFFFF" d="M73.5,31.6h-9.1c-1.4,0-3.6,0.8-3.6,3.9v8.5h12.6L72,58.3H60.8v40.8H43.9V58.3h-8V43.9h8v-9.2
              c0-6.7,3.1-17,17-17h12.5v13.9H73.5z" />
                                </svg></span>
                            </a>
                            <a className="u-social-url" title="twitter" target="_blank" href><span className="u-icon u-social-icon u-social-twitter u-icon-2"><svg className="u-svg-link" preserveAspectRatio="xMidYMin slice" viewBox="0 0 112 112" style={{}}>
                                <use xmlnsXlink="http://www.w3.org/1999/xlink" xlinkHref="#svg-73bf" />
                            </svg><svg className="u-svg-content" viewBox="0 0 112 112" x={0} y={0} id="svg-73bf">
                                    <circle fill="currentColor" className="st0" cx="56.1" cy="56.1" r={55} />
              ...
              c2.7-0.3,5.3-1,7.7-2.1C88.7,43,86.4,45.4,83.8,47.3z" />
                            ...
                            <a className="u-social-url" title="instagram" target="_blank" href><span className="u-icon u-social-icon u-social-instagram u-icon-3"><svg className="u-svg-link" preserveAspectRatio="xMidYMin slice" viewBox="0 0 112 112" style={{}}>
                                <use xmlnsXlink="http://www.w3.org/1999/xlink" xlinkHref="#svg-246a" />
                            </svg><svg className="u-svg-content" viewBox="0 0 112 112" x={0} y={0} id="svg-246a">
                                    <circle fill="currentColor" cx="56.1" cy="56.1" r={55} />
              ...
              c5.5,0,9.9,4.5,9.9,9.9V73.3z" />
                            ...
                            <a className="u-social-url" title="linkedin" target="_blank" href><span className="u-icon u-social-icon u-social-linkedin u-icon-4"><svg className="u-svg-link" preserveAspectRatio="xMidYMin slice" viewBox="0 0 112 112" style={{}}>
                                <use xmlnsXlink="http://www.w3.org/1999/xlink" xlinkHref="#svg-24c2" />
                            </svg><svg className="u-svg-content" viewBox="0 0 112 112" x={0} y={0} id="svg-24c2">
                                    <circle fill="currentColor" cx="56.1" cy="56.1" r={55} />
              ...
              H48.7c0,0,0.2-36.5,0-40.3h13.4v5.7c1.8-2.7,5-6.7,12.1-6.7c8.8,0,15.4,5.8,15.4,18.1V83.7z" />
                        ...
                        <p className="u-text u-text-default u-text-1"><span className="u-icon u-icon-5"><svg className="u-svg-content" viewBox="0 0 512 512" style={{ width: '1em', height: '1em' }}>
                ...
                </footer><span style={{ height: '64px', width: '64px', marginLeft: '0px', marginRight: 'auto', marginTop: '0px', backgroundImage: 'none', right: '20px', bottom: '20px' }} className="u-back-to-top u-icon u-icon-circle u-opacity u-opacity-85 u-palette-1-base u-spacing-15" data-href="#">
                    <svg className="u-svg-link" preserveAspectRatio="xMidYMin slice" viewBox="0 0 551.13 551.13">
                        <use xmlnsXlink="http://www.w3.org/1999/xlink" xlinkHref="#svg-1d98" />
                    </svg>
