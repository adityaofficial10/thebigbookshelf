                            ...
                            <div className="u-layout-row">
                                ...
                                <div className="u-align-center-sm u-align-center-xs u-container-style u-layout-cell u-shape-rectangle u-size-29 u-white u-layout-cell-2">
                                    <div className="u-container-layout u-container-layout-2">
                                        ...
                                        <div className="u-form u-form-1">
                                            <form action="#" method="POST" className="u-clearfix u-form-spacing-10 u-form-vertical u-inner-form" source="custom" name="form" style={{ padding: '10px' }}>
                                                <div className="u-form-group u-form-group-1">
                                                    ...
                                                    <input type="text" placeholder="Full Name" id="text-6205" name="text-3" className="u-border-1 u-border-black u-input u-input-rectangle u-radius-50 u-text-grey-30 u-white u-input-1" />
                                                </div>
                                                <div className="u-form-group u-form-group-2">
                                                    <label htmlFor="text-a4f4" className="u-form-control-hidden u-label" />
                                                    <input type="text" placeholder="Username" id="text-a4f4" name="text-2" className="u-border-1 u-border-black u-input u-input-rectangle u-radius-50 u-text-grey-30 u-white u-input-2" />
                                                </div>
                                                <div className="u-form-email u-form-group">
                                                    <label htmlFor="email-1136" className="u-form-control-hidden u-label" />
                                                    <input type="email" placeholder="Enter a valid email address" id="email-1136" name="email" className="u-border-1 u-border-black u-input u-input-rectangle u-radius-50 u-text-grey-30 u-white u-input-3" required />
                                                </div>
                                                <div className="u-form-group u-form-group-4">
                                                    <label htmlFor="text-1a0e" className="u-form-control-hidden u-label" />
                                                    <input type="text" placeholder="Password" id="text-1a0e" name="text" className="u-border-1 u-border-black u-input u-input-rectangle u-radius-50 u-text-grey-30 u-white u-input-4" />
                                                </div>
                                                <div className="u-form-group u-form-group-5">
                                                    <label htmlFor="text-642a" className="u-form-control-hidden u-label" />
                                                    <input type="text" placeholder="Confirm Password" id="text-642a" name="text-1" className="u-border-1 u-border-black u-input u-input-rectangle u-radius-50 u-text-grey-30 u-white u-input-5" />
                                                </div>
                                                <div className="u-align-center u-form-group u-form-submit">
                                                    <a href=" " className="u-btn u-btn-round u-btn-submit u-button-style u-hover-palette-1-dark-1 u-palette-1-base u-radius-50 u-btn-1">Signup</a>
                                        ...
                                        <Link to="/login" data-page-id={150501387} className="u-border-1 u-border-active-palette-1-base u-border-hover-palette-1-base u-btn u-button-style u-login-control u-login-forgot-password u-none u-text-palette-1-base u-btn-2">Already Have an Account ?<br />
                                        </Link>
                                    </div>
                                </div>
                            </div>
